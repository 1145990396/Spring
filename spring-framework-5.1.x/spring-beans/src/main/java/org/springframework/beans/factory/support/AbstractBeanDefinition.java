 ...
 *提取出{@link GenericBeanDefinition}的公共属性，
 * {@link RootBeanDefinition}和{@link ChildBeanDefinition}。
 *中的自动装配常数与定义的自动装配常数匹配
...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 默认作用域名称的常量:{@code ""}，等价于singleton
	 * 状态，除非被父bean定义覆盖(如果适用)。
	 */
	...
	//beanDefintion的class   可能不是最终bean的class
	@Nullable

package com.baidu.batis;

import com.baidu.proxy1.ServiceLog;
...
public class LubanProxy {
	...
	public static Object getInstance(Object target) throws MalformedURLException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		...
		String line = "\n";//换行
		String tab = "\t";//tab
		String packageContent = "package com.luban;" + line;
		...
		File file = new File("E:\\鲁班学院\\spring 源码专题\\$ProxyLuban.java");
		...
		Class cls = urlClassLoader.loadClass("com.luban.$ProxyLuban");
